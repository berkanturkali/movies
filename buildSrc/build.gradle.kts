import Build_gradle.Plugin.Version.DETEKT_VERSION
...
object Plugin {
    ...
    const val DETEKT_PLUGIN = "io.gitlab.arturbosch.detekt:detekt-gradle-plugin:$DETEKT_VERSION"
...
//    implementation(Plugin.DETEKT_PLUGIN)
}